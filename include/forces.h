...
/**
 * Adds a force creator to a scene that applies gravity between two bodies.
 * The force creator will be called each tick to apply a downward gravitational force
 * to any body passed in 
 * @param scene the scene containing the bodies
 * @param G the gravitational proportionality constant
 * @param body1 the body to apply downward gravity to
 */
...
void increase_slime_collision_force(body_t *body1, body_t *body2, vector_t axis, void *aux, double overlap);
...
/**
 * Adds a force creator to a scene that destroys the one body when they collide.
 * The bodies should be destroyed by calling body_remove().
 * This should be represented as an on-collision callback
 * registered with create_collision().
 *
 * @param scene the scene containing the bodies
 * @param body1 the body that is destroyed
 * @param body2 the body that is not destroyed
 */

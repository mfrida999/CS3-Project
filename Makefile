...
DEMOS = game #bounce gravity pacman nbodies damping spaceinvaders pegs breakout
...
STUDENT_LIBS = list vector polygon body scene forces collision shape sdl_mixer #game
